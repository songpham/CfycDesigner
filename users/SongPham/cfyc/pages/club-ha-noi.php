    ...
    <div id="banner" class="row banner-top">
        <div class="cta">
            <fieldset>
                ...
                <div class="red-btn">
                    <a class="cta" href="#" title="Discover Cali Dance"> <?php echo LANG_CLUB_HA_NOI_BANNER_TEXT_BUTTON ?></a>
                </div>
            </fieldset>
        </div>
    </div>
        ...
        <div class="quan quan-hoan-kiem" style='display:block;'>
            ...
            <div class="row information">
                <div class="container-page">
                    ...
                    <div class="col-md-12 see-more-btn"><a href="#"><?php echo LANG_CLUB_HA_NOI_BOOK_BUTTON ?></a></div>
                </div>
            </div>
            <!-- END INFOMATION -->
        ...
        <div class="quan royal-city">
            ...
            <div class="row information">
                <div class="container-page">
                    ...
                    <div class="col-md-12 see-more-btn"><a href="#"><?php echo LANG_CLUB_HA_NOI_CENT_BUTTON ?></a></div>
                </div>
            </div>
            <!-- END INFOMATION -->
