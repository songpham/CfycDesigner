...
<?php include USER_BASE_PATH . '/templates/nav-bar.php'; ?>
    ...
    <?php
    $scheduleData = NULL;
    $jsonScheduleData = json_decode(file_get_contents(PROTOCOL . '://' . API_CFYC_URL . '/schedule/?function=list&lang=' . $LANG), true);
    if (empty($jsonScheduleData) === FALSE && $jsonScheduleData['success'] === TRUE) {
        $scheduleData = $jsonScheduleData['results'];
    }
