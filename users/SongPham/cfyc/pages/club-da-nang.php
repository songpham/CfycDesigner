            ...
            <fieldset>
                ...
                <div class="red-btn">
                    <div class="red-btn-inline">
                        <a class="cta" href="<?php echo USER_BASE_URL ?>/<?php echo createUrl('vip-members' . getSuffix('lang=' . $LANG)) ?>" title="Discover Cali Dance"> <?php echo LANG_CLUB_DA_NANG_BANNER_TEXT_BUTTON ?></a>
                    </div>
                </div>
            </fieldset>
        </div>
        ...
        <div class="quan" style='display:block;'>
            ...
            <div class="slideshow">
                    ...
                    <div class="container-page">
                        <div class="carousel-indicators thumbs">
                            <div class="col-md-2 col-sm-3 col-xs-3 text-center box active" data-target="#slideshow-1" data-slide-to="0">
                                <div class="box-inner"><img data-src="<?php echo USER_BASE_URL ?>/img/club/desktop/danang/club1/thumbs/1.jpg" alt=""></div>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-3 text-center box" data-target="#slideshow-1" data-slide-to="1">
                                <div class="box-inner"><img data-src="<?php echo USER_BASE_URL ?>/img/club/desktop/danang/club1/thumbs/2.jpg" alt=""></div>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-3 text-center box" data-target="#slideshow-1" data-slide-to="2">
                                <div class="box-inner"><img data-src="<?php echo USER_BASE_URL ?>/img/club/desktop/danang/club1/thumbs/3.jpg" alt=""></div>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-3 text-center box" data-target="#slideshow-1" data-slide-to="3">
                                <div class="box-inner"><img data-src="<?php echo USER_BASE_URL ?>/img/club/desktop/danang/club1/thumbs/4.jpg" alt=""></div>
                            </div>
                            <!-- Controls -->
                ...
                <div id="slideshow-1-m" class="carousel slide mobile" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img data-src="<?php echo USER_BASE_URL ?>/img/club/mobile/danang/club1/1.jpg"  title="Visit us for a free membership trial today" alt="Visit us for a free membership trial today">
                        </div>
                        <div class="item">
                            <img data-src="<?php echo USER_BASE_URL ?>/img/club/mobile/danang/club1/2.jpg"  title="Visit us for a free membership trial today" alt="Visit us for a free membership trial today">
                        </div>
                        <div class="item">
                            <img data-src="<?php echo USER_BASE_URL ?>/img/club/mobile/danang/club1/3.jpg"  title="Visit us for a free membership trial today" alt="Visit us for a free membership trial today">
                        </div>
                        <div class="item">
                            <img data-src="<?php echo USER_BASE_URL ?>/img/club/mobile/danang/club1/4.jpg"  title="Visit us for a free membership trial today" alt="Visit us for a free membership trial today">
                        </div>
                        <div class="carousel-caption">
                            <?php echo LANG_CLUB_HCM_CLUB_1_CAPTION_1 ?>
                        </div>
