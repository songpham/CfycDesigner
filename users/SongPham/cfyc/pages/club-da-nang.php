...
<div class="container-fluid page club-page">
    ...
    <div class="row introduce">
        <div class="container-page">
            <p>California Fitness & Yoga tự hào đồng hành cùng bạn với câu lạc bộ lớn nhất Đông Nam Á tại Đà Nẵng, không chỉ giúp bạn tăng cường sức khỏe mà còn mang đến sự kết nối xã hội, giúp bạn đạt được mục tiêu và có cuộc sống tươi đẹp hơn.</p>
        </div>
    </div>
    <!-- END CLUB INTRODUCE -->
    ...
    <div class="row">
        <div id="club-list" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <div class="row">
                        <div class="col-md-4 hide-sm hide-xs text-center"></div>
						<div class="col-md-1 hide-sm hide-xs text-center"></div>
                        <div class="col-md-2 col-sm-3 col-xs-6 text-center box active">
                            <a href='quan-thanh-khe'><img src="<?php echo USER_BASE_URL . "/img/club/club.png" ?>" alt=''></a>
                            <p>QUẬN THANH KHÊ</p> 
                        </div>
						<div class="col-md-1 hide-sm hide-xs text-center"></div>
                        <div class="col-md-4 hide-sm hide-xs text-center"></div>
    ...
    <!-- QUAN THANH KHE -->
    <div class="quan quan-thanh-khe" style='display:block;'>
        <!-- CLUB NAME -->
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">CLB QUẬN THANH KHÊ</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
        ...
        <div class="slideshow row">
            <div id="slideshow-1" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <div class="carousel-caption">
							Trung tâm thể hình và phong cách sống lớn nhất Việt Nam tại Đà Nẵng, mang đến sự kết hợp hoàn hảo giữa các phương pháp thể hình hàng đầu và môi trường tập luyện tiêu chuẩn quốc tế, cam kết giúp bạn thay đổi hoàn toàn cơ thể và cuộc sống                        </div>
        ...
        <div class="row information">
            <div class="container-page">
                <div class="col-md-6">
                    ...
                    <!-- location -->
                    <h3>Địa điểm :</h3>
                    <p>155 Nguyễn Văn Linh, Quận Thanh Khê, TP. Đà Nẵng	</p>

                    <!-- operating hours -->
                    <h3>Giờ hoạt động : </h3>
                    <p>Thứ 2 đến Chủ nhật : 5:00 - 22:00 </p>

                    <!-- contact -->
                    <h3>Liên hệ :  </h3>
                    <p>Tel: (0511) 3538 999</p>
