...
<div class="row banner-top">
    <a href="javascript:void(0)" title="<?=LANG_BANNER_TITLE?>" alt="<?=LANG_BANNER_TITLE?>">
        <img class="img-responsive" src="img/home/california-wow-banner-<?=$LANG?>.jpg"  title="<?=LANG_BANNER_TITLE?>" alt="<?=LANG_BANNER_TITLE?>">
    </a>
</div>
<div class="container-page">
	<div class="strike"><h2>Choose you city</h2></div>
    <h4 class="text-center col-sm-10 col-sm-offset-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro voluptas, consequuntur atque, placeat quibusdam voluptates facilis omnis error dolores sunt totam itaque voluptatum modi odio, et dolor, nisi laborum magnam.</h4>
