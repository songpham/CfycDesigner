...
<div class="container-fluid page club-page">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="carousel-caption">
                        ...
                        <a href="#" title="Find a club in HCMC today">Find a club in HCMC today</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row introduce">
        <div class="container-page">
            <p>Discover our wide variety of fitness, health and lifestyle clubs available throughout Ho Chi Minh City. Since 2007 when our first five star location opened up in Houng Voung Plaza, District 5, we have grown rapidly.</p>
        </div>
    </div>
    <!-- END CLUB INTRODUCE -->
    ...
    <div class="quan quan-11" style='display:block;'>
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">QUAN 11</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
        ...
        <div class="row infomation">
            <div class="container-page">
                <div class="col-md-6">
                    ...
                    <!-- location -->
                    <h3>Location: </h3>
                    <p>Pico Plaza ,20 Cong Hoa, Ward 12, Tan Binh District</p>

                    <!-- operating hours -->
                    <h3>Operating hours: </h3>
                    <p>Monday to Friday: 6:00 - 23:00</p>
                    <p>Saturday & Sunday : 6:00 - 22:00	</p>
                ...
                <div class="col-md-12 see-more-btn"><a href="#">book a vip visit</a></div>
            </div>
        </div>
        <!-- END INFOMATION -->
    ...
    <div class="quan quan-tan-binh">
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">QUAN TAN BINH</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
    ...
    <div class="quan quan-4">
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">QUAN 4</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
    ...
    <div class="quan quan-5">
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">QUAN 5</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
    ...
    <div class="quan quan-5">
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">QUAN 1</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
    ...
    <div class="quan quan-7">
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">QUAN 7</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
    ...
    <div class="quan quan-thu-duc">
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">QUAN THU DUC</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
    ...
    <div class="quan crescent">
        ...
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">CRESCENT [CENTURYON]</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
