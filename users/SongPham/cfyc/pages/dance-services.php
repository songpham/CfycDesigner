    ...
    <div id="banner" class="row banner-top">
        <div class="cta">
            <fieldset>
                ...
                <div class="red-btn">
                    <a class="cta" href="javascript:animateTo($('.contactform'))" title="<?=LANG_DANCE_BANNER_TEXT_CTA?>"> <?=LANG_DANCE_BANNER_TEXT_CTA?></a>
                </div>
            </fieldset>
        </div>
    </div>
    ...
    <div class="contactform container">
        <div class="row" id="form">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                ...
                <div id="signUp_form">
	                <?php if ($LANG == 'vn') { ?>
	                <script type="text/javascript" src="http://app.getresponse.com/view_webform.js?wid=9193105&amp;u=kKTV"></script>
	                <?php } else if ($LANG == 'en') { ?>
	                <script type="text/javascript" src="http://app.getresponse.com/view_webform.js?wid=8580005&amp;u=kKTV"></script>
	                <?php } ?>
				</div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 hidden-xs"></div>
