...
<div class="container-fluid">
    <div class="row gallery">
        <a href="javascript:void(0)" title="Visit us for a free membership trial today" alt="Visit us for a free membership trial today">
            <img src="img/home/california-wow-banner-1.jpg"  title="Visit us for a free membership trial today" alt="Visit us for a free membership trial today">
        </a>
    </div><!-- /.Top Banner -->    
    <div class="row top-content">
        <div class="holder-top-content">
                ...
                <div class="row ourservice">
                    <div class="col-md-4 col-sm-4 col-xs-6 service_item">
                        <div class="service_img">
                            <img src="img/home/california-wow-our-services-1.jpg" alt="Personal Trainner" title="Personal Trainner">
                        </div>
                        <div class="overlay">
                            <h2 class="service_title">Personal Trainner</h2>
                       </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 service_item">
                        <div class="service_img">
                            <img src="img/home/california-wow-our-services-2.jpg" alt="Yoga" title="Yoga">
                        </div>
                        <div class="overlay">
                            <h2 class="service_title">Yoga</h2>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 service_item">
                        <div class="service_img">
                            <img src="img/home/california-wow-our-services-3.jpg" alt="Group Exercise" title="Group Exercise">
                        </div>
                        <div class="overlay">
                            <h2 class="service_title">Group Exercise</h2>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 service_item">
                        <div class="service_img">
                            <img src="img/home/california-wow-our-services-4.jpg" alt="Kid's Program" title="Kid's Program">
                        </div>
                        <div class="overlay">
                            <h2 class="service_title">Kid's Program</h2>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 service_item">
                        <div class="service_img">
                            <img src="img/home/california-wow-our-services-5.jpg" alt="Spa esthic" title="Spa esthic">
                        </div>
                        <div class="overlay">
                            <h2 class="service_title">Spa esthic</h2>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 service_item">
                        <div class="service_img">
                            <img src="img/home/california-wow-our-services-6.jpg" alt="Kickfit" title="Kickfit">
                        </div>
                        <div class="overlay">
                            <h2 class="service_title">Kickfit</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="row findyourclub">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <img class="hidden-xs" src="img/home/california-wow-find-your-club-1.jpg" alt="Club in Ho Chi Minh City" title="Club in Ho Chi Minh City">
                        <img class="hidden-lg hidden-sm hidden-md" src="img/home/california-wow-find-your-club-1_sm.jpg" alt="Club in Ho Chi Minh City" title="Club in Ho Chi Minh City">
                        <div class="overlay">
                            <h2 class="service_title">Ho Chi Minh City</h2>
                        </div>
                    </div>                
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        ...
                        <div class="overlay">
                            <h2 class="service_title">New Coming</h2>
                        </div>
                    </div>
                ...
                <div class="row find_your_trainner container-page">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 trainner_text">
                         <div class="trainner_desc" id="linhta2">
                            <h3>ASSIM MANN<br/><span>QUẢN LÍ BỘ PHẬN YOGA</span></h3>
                        ...
                        <div class="trainner_desc active" id="linhta">
                            <h3>TIỂU PHƯƠNG<br/><span>HLV CÁ NHÂN</span></h3>
                        ...
                        <div class="trainner_desc" id="linhta1">
                            <h3>MINT NGUYỄN<br/><span>QUẢN LÝ CẤP TOÀN QUỐC</span></h3>
            ...
            <div class="whitespace"></div>
            <div class="col-md-12 text-center">
                <h2><span>CELEBRITIES MEMBERS</span></h2>
                <div class="row">
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-6">
