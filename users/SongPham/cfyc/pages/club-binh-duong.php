...
<div class="container-fluid page club-page">
    ...
    <div class="row introduce">
        <div class="container-page">
            <p>California Fitness & Yoga tự hào đồng hành cùng bạn với câu lạc bộ tiêu chuẩn 5 sao đầu tiên tại Bình Dương, không chỉ giúp bạn tăng cường sức khỏe mà còn mang đến sự kết nối xã hội, giúp bạn đạt được mục tiêu và có cuộc sống tươi đẹp hơn.</p>
        </div>
    </div>
    <!-- END CLUB INTRODUCE -->
                ...
                <div class="item active">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-6 text-center box active">
                            <a href='thu-dau-mot'><img src="<?php echo USER_BASE_URL . "/img/club/club.png" ?>" alt=''></a>
                            <p>TP.THỦ DẦU MỘT</p> 
                        </div>
						<div class="col-md-1 hide-sm hide-xs text-center"></div>
                        <div class="col-md-4 hide-sm hide-xs text-center"></div>
    ...
    <!-- QUAN THU DAU 1 -->
    <div class="quan thu-dau-mot" style='display:block;'>
        <!-- CLUB NAME -->
        <div class="row block">
            <div class='block-title'>
                <div class="title-text">CLB TP.THỦ DẦU MỘT</div>
            </div>
        </div>
        <!-- END CLUB NAME -->
        ...
        <div class="slideshow row">
            <div id="slideshow-1" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <div class="carousel-caption">
							Mang phong cách sống mạnh mẽ và năng động đến gần người dân tỉnh Bình Dương hơn bao giờ hết, chúng tôi mong muốn giúp bạn thay đổi cơ thể, thay đổi cuộc sống
						</div>
        ...
        <div class="row information">
            <div class="container-page">
                <div class="col-md-6">
                    ...
                    <!-- location -->
                    <h3>Địa điểm :</h3>
                    <p>Tầng 3, Tòa nhà Bình Dương Square, 01 Phú Lợi, Khu 1, Phường Phú Lợi TP. Thủ Dầu Một, Tỉnh Bình Dương</p>
