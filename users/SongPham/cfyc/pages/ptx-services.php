<div class="container-fluid page ptx-services-page">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="<?php echo USER_BASE_URL ?>/img/ptx-services/topbanner.jpg" alt="PTX Services">
    ...
    <div class="benefits">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 cover">
            <a href="#" title="PTX Work">
                <img class="img-responsive" src="<?php echo USER_BASE_URL ?>/img/ptx-services/ptxwork-2.jpg" alt="PTX Work">
            </a>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="school row">
        ...
        <div id="carousel-example-generic-clubs" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="img-responsive" src="<?php echo USER_BASE_URL ?>/img/ptx-services/ptx-room.jpg" alt="School">
                </div>
                <div class="item">
                    <img class="img-responsive" src="<?php echo USER_BASE_URL ?>/img/ptx-services/ptx-room.jpg" alt="School">
                </div>
    ...
    <div class="trainers container">
        <h2><div class="line"></div>Meet some of our top ptx2 instructors<div class="line"></div></h2>
