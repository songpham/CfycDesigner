...
// CLUBS LIST
define('LANG_CLUB_HA_NOI_CLUB_1', 'HOAN KIEM DIST.');
define('LANG_CLUB_HA_NOI_CLUB_2', 'DONG DA DIST');
define('LANG_CLUB_HA_NOI_CLUB_3', 'HAI BA TRUNG DIST');
define('LANG_CLUB_HA_NOI_CLUB_4', 'ROYAL CITY');
...
define('LANG_CLUB_HA_NOI_CLUB_1_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>Capital Building, 41, Hai Ba Trung,	Hoan Kiem District., HN</p>
        
        <h3>Operating hours: </h3>
        <p>Monday to Friday: 6:00 - 22:00</p>
        <p>Saturday & Sunday: 6:00 - 21:00</p>
...
define('LANG_CLUB_HA_NOI_CLUB_2_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>Sky City Tower, 88 Lang Ha,	Dong Da District, HN</p>
        
        <h3>Operating hours: </h3>
        <p>Monday to Friday: 5:45 - 22:00</p>
        <p>Saturday & Sunday: 5:45- 21:00</p>
...
define('LANG_CLUB_HA_NOI_CLUB_3_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>Times City, T18 Building, Hai Ba Trung District, HN.</p>
...
define('LANG_CLUB_HA_NOI_CLUB_4_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>Royal City Commercial Center, 72A Nguyen Trai Str, Thuong Dinh Ward, Thanh Xuan Dist, Hanoi, Vietnam</p>
        
        <h3>Operating hours: </h3>
        <p>Monday to Sunday: 6am - 10pm</p>

        <h3>Contact: </h3>
        <p>Tel: (04) 6664 6088</p>
        <p>Mail: info@cfyc.com.vn</p>
    ');


// OTHER BUTTON
define('LANG_CLUB_HA_NOI_BOOK_BUTTON', "Book a VIP Visit");
define('LANG_CLUB_HA_NOI_CENT_BUTTON', "Centuryon Website");
