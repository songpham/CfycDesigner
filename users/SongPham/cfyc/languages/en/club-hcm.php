...
define('LANG_CLUB_HCM_BANNER_SUB_TITLE', 'Ho Chi Minh City’s first and most premium fitness, entertainment and lifestyle destination Visit a club today for a  free trial');
define('LANG_CLUB_HCM_BANNER_TEXT_BUTTON', 'Get A Trial');
...
// CLUBS LIST
define('LANG_CLUB_HCM_CLUB_1', 'DISTRICT 11');
define('LANG_CLUB_HCM_CLUB_2', 'TAN BINH DIST.');
define('LANG_CLUB_HCM_CLUB_3', 'DISTRICT 4');
define('LANG_CLUB_HCM_CLUB_4', 'DISTRICT 5');
define('LANG_CLUB_HCM_CLUB_5', 'DISTRICT 1');
define('LANG_CLUB_HCM_CLUB_6', 'DISTRICT 7');
define('LANG_CLUB_HCM_CLUB_7', 'THU DUC DIST.');
...
define('LANG_CLUB_HCM_CLUB_1_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>5th floor, Parkson Flemington, 184 Le Dai Hanh, Ward 15, District 11, HCMC</p>
...
define('LANG_CLUB_HCM_CLUB_3_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>California at the Waterfront 05 Nguyen Tat Thanh, Ward 12, District 4.HCMC</p>
...
define('LANG_CLUB_HCM_CLUB_4_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>5th floor, Hung Vuong Plaza, 126 Hung Vuong , District 5, HCMC</p>
...
define('LANG_CLUB_HCM_CLUB_5_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>Queen Ann Building ,28-30-32 Le Lai , District 1, HCMC</p>
...
define('LANG_CLUB_HCM_CLUB_7_CONTACT_INFO', '
        <h3>Location: </h3>
        <p>216 Vo Van Ngan, Binh Tho Ward, Thu Duc District, HCMC</p>
