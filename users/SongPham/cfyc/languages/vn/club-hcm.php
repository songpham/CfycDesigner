...
// DESCRIPTION 
define('LANG_CLUB_HCM_INTRODUCE', 'California Fitness & Yoga tự hào đồng hành cùng bạn với 8 câu lạc bộ ở TP.HCM, không chỉ giúp bạn tăng cường sức khỏe mà còn mang đến sự kết nối xã hội, giúp bạn đạt được mục tiêu và có cuộc sống tươi đẹp hơn.');
...
// OTHER BUTTON
define('LANG_CLUB_HCM_BOOK_BUTTON', "Nhận vé tham quan miễn phí");
