<?php
define("LANG_VIP", "Đăng kí tham quan dành cho Vip tại Trung Tâm Thể Dục Thể Hình & Yoga California tại Việt Nam");
define("LANG_VIP_RSVP_NOW", "hơn 7 năm qua, với sứ mệnh mang lại cuộc sống tốt đẹp hơn, trung tâm là nơi hội tụ của luyện tập, thời trang và giải trí trong môi trường lành mạnh và tràn đầy năng lượng nhằm đem lại trải nghiệm nâng tầm cuộc sống.<br/><br/>chúng tôi mang đến cho bạn những sự lựa chọn hoàn hảo bao gồm:");
define("LANG_VIP_RSVP_INCLUDE_1","tư vấn viên độc quyền");
define("LANG_VIP_RSVP_INCLUDE_2","Học cách nâng cao chất lượng cuộc sống và đạt được thân hình thon gọn ,săn chắc như mơ ước");
define("LANG_VIP_RSVP_INCLUDE_3","phân tích, tư vấn thể chất");
define("LANG_VIP_RSVP_INCLUDE_4","Cùng các chuyên gia tư vấn và phân tích cơ thể đạt được thân hình thon gọn và săn chắc thông qua giảm cân, tăng cơ cùng các phương pháp khoa học khác");
