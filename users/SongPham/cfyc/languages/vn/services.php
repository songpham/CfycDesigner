...
define('LANG_SERVICES_HOME_BANNER_TITLE','Bạn đã là hội viên chưa?');
define('LANG_SERVICES_HOME_BANNER_SUBTEXT', 'Khám phá ngay những lợi ích độc nhất của hội viên California Fitness & Yoga Đăng kí để tìm hiểu thêm và tập thử miễn phí ngay hôm nay');
define('LANG_SERVICES_HOME_BANNER_CTA', 'đăng kí tập thử');


define('LANG_SERVICES_HOME_MAIN_TITLE', 'Life Enhancement Dịch Vụ');
